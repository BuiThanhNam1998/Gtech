                  ...
                  <input type="hidden" name="_token" value="{{csrf_token()}}" />
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2">Nội dung<span class="required">*</span></label>
                        <div class="col-sm-10">
                          <textarea class="form-control ckeditor" name="noidung" rows="6" id="noidung"></textarea>
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <select class="form-control m-bot15" name="danhmuc" id="danhmuc" required>
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <select class="form-control m-bot15" name="danhmuccon" id="danhmuccon" required>
